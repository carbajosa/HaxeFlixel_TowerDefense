...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "TD", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "TD", null, { width: 300, height: 250 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 300, height: 250 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 300, 250, "null");
		#end
		#else
		create ();
		#end
